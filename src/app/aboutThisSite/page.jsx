    ...
    return (
        <div className={styles.container}>
            ...
            <section className={styles.section}>
                ...
                <p className={styles.text}>
                    The backend is written by <strong>Python</strong>. The &quot;Chat With AI Me&quot; feature uses <strong>LangChain</strong> for managing conversations and integrations. The LLM I choose is <strong>GPT-4o-mini</strong>, a model optimized for cost-efficient and accurate large language model interactions.
                </p>
                <p className={styles.text}>
